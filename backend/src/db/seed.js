...
async function seed() {
  ...
  insertMessage.run(
    ...
    author1Id,
    "author",
    "The wrong ISBN shown on Amazon listing is causing issues. Please fix this urgently.",
    0,
    0,
  );
  insertMessage.run(
    ...
    adminId,
    "admin",
    "Thank you for reporting this. We have flagged the issue with our metadata team and are in contact with Amazon. We expect this to be resolved within 3-5 business days. We will keep you updated.",
    0,
    1,
  );
  ...
  insertMessage.run(
    ...
    adminId,
    "admin",
    "Hi Arjun, to update your author biography, please email your new bio (max 300 words) along with an updated author photo to authors@bookleaf.com. We will update it within 2-3 business days.",
    0,
    0,
  );
  insertMessage.run(
    ...
    author1Id,
    "author",
    "Thank you! I have sent the updated bio to the email address provided.",
    0,
    0,
  );
